    ...
    <div class="col-lg-2 col-md-3 col-sm-4">
        <div class="bs-sidebar">
            <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
                <a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter un Casier}}</a>
        ...
        <form class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">{{Nom du casier}}</label>
                    <div class="col-sm-3">
                        <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
                        <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom du casier}}"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">{{Largeur du casier}}</label>
                    <div class="col-sm-3">
                        <input type="text" class="eqLogicAttr configuration form-control" data-l1key="configuration" data-l2key="widthCase" placeholder="Nombre de bouteilles"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">{{Hauteur du casier}}</label>
                    <div class="col-sm-3">
...
<?php include_file('desktop', 'CaveVin', 'js', 'CaveVin');?>
